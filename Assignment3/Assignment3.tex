...
\begin{enumerate}
    ...
    \begin{align}
    \myvec{\vec{P}-\vec{B}}\myvec{\vec{A}-\vec{B}}^T=0 \label{eq2.2}
    \end{align}
    \begin{align}
    \myvec{\vec{P}-\vec{C}}\myvec{\vec{A}-\vec{C}}^T=0 \label{eq2.3}
    \end{align}
\end{enumerate}
We need to prove that the line  $AP$  bisects the angle between them \begin{align}
 ...
 \begin{align}
 \implies 
 \frac{(\vec A -\vec B)^T}{\norm{\vec{A}-\vec{B}}} \enspace = \enspace \frac{(\vec A -\vec C)^T}{\norm{\vec{A}-\vec{C}}} \label{eq2.4}
\end{align}
 From \eqref{eq2.2} and \eqref{eq2.3},We can write that
 \begin{align}
 \myvec{\vec{P}-\vec{B}}\myvec{\vec{A}-\vec{B}}^T=\myvec{\vec{P}-\vec{C}}\myvec{\vec{A}-\vec{C}}^T
 \end{align}
 using \eqref{eq2.2} , the above equation reduces to
 \begin{align}
 \myvec{\vec{A}-\vec{B}}^T=\myvec{\vec{A}-\vec{C}}^T  \label{eq2.5}
  \end{align}
  By using \eqref{eq2.5} in \eqref{eq2.4},We can say that the line $AP$ bisects the angle between them
  \begin{align}
