...
As the required line passes through the point of intersection (0.07, 0.38) and the intercepts are equal, the intercepts can be written as:
...
\begin{pmatrix}
    ...
    0
\end{pmatrix}\\
we know that the standard equation for the line with intercepts in vector form is , 
\begin{center}
\textbf{r} = a+bt 
\end{center}
Based on the intercept details,The line equation in vector form is 
\begin{center}
