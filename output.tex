...
\begin{pmatrix}
4 & 7
\end{pmatrix}\textbf{x}=3 and 
\begin{pmatrix}
2 & -3
\end{pmatrix}\textbf{x}=-1

\newline 
This is done finding the solution of the linear equations 
\newline
\newline 
...
-1
\end{bmatrix}\]
2 Calculate the value of x using  matrix inversion method.\\
\newline
\[\textbf{x} = \begin{bmatrix}
0.07692307692307682\\
-10.38461538461538464
\end{bmatrix}\]

\section{Solution}

The standard equation with the intercepts is : x/a +y/b =1.
As per the question ,a=b
\newline
\newline
so the line equation becomes x+y = a
\newline
\newline\newline
Required line equation passing through the point of intersection is x+y=0.46153846153846145 \end{document}
