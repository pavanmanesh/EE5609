...
\begin{abstract}
This document explains how to find a row-reduced matrix which is row equivalent to given matrix
\end{abstract}
...
\section{Solution}
On performing elementary row operations on $\eqref{A}$,
\begin{align}
\vec{R}=\vec{B}\vec{A}
\end{align}
...
\begin{align}
\vec{B}= 
\myvec{1&i&0\\0&1&0\\0&0&1}\myvec{1&0&0\\0&1&0\\0&-i&1}\myvec{1&0&0\\0&\frac{1}{4}(1-i)&0\\0&0&1}\myvec{1&0&0\\-2&1&0\\-i&0&1} 
\end{align}
\begin{align} \vec{B}= \myvec{\frac{1}{2}(1-i)&\frac{1}{4}(1+i)&0\\
\frac{1}{2}(-1+i)&\frac{1}{4}(1-i)&0\\
\frac{1}{2}(1-i)&\frac{1}{4}(-1-i)&1}
\end{align}
\begin{align}
\vec{R}=\myvec{1&0\\0&1\\0&0} \label{R}
\end{align}
$\Therefore$ Row-reduced matrix of $\vec{A}$ is,
\begin{align}
...
\end{align}
The solution of  A$\vec{x}=$\vec{0} is,
\begin{align}
\vec{I_2} \vec{x} = 0\\
\implies \vec{x} = 0
\end{align}
